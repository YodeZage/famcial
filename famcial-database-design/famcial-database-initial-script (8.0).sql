...
-- -----------------------------------------------------
-- Table `famcial`.`purpose`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `famcial`.`purpose` (
...
-- Table `famcial`.`payer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `famcial`.`payer` (
...
CREATE TABLE IF NOT EXISTS `famcial`.`transaction` (
  ...
  `store_id` INT UNSIGNED NULL COMMENT 'store id for the transaction',
  `payer_id` INT UNSIGNED NULL,
  `purpose_id` INT UNSIGNED NOT NULL COMMENT 'project id for the transaction',
  ...
  INDEX `fk_transaction_project1_idx` (`purpose_id` ASC) VISIBLE,
  ...
  INDEX `fk_transaction_payer1_idx` (`payer_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_transaction_sub_category1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_transaction_payer1`
    FOREIGN KEY (`payer_id`)
    REFERENCES `famcial`.`payer` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
